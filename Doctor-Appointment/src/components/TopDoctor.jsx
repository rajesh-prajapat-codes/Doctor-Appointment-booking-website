...
const TopDoctor = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
      ...
      <button onClick={() => { navigate('/doctor'); scrollTo(0,0)}} className='bg-blue-200 text-gray-600 px-12 py-3 rounded-full mt-10 cursor-pointer hover:bg-blue-300'>More</button>
    </div>
  )
}
