      ...
      <div className='flex items-center gap-4'>
        {
          token
            ...
            :<button onClick={() => navigate('/login')} className='bg-purple-500 text-white px-8 py-3 rounded-full font-light hidden md:block cursor-pointer '>Create Acount</button>
        }
